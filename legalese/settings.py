"""
Django settings for legalese project.
...
SECRET_KEY = 'xsk$u!usoj($m2@&(y75ibq7s)thr(0$%yb3e_s)6f4byipwng'
...
ROOT_URLCONF = 'legalese.urls'

WSGI_APPLICATION = 'legalese.wsgi.application'
